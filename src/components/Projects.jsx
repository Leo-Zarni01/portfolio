      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {PROJECTS.map((project, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 flex flex-col items-center justify-center text-purple-800 font-bold opacity-0 backdrop-blur-lg transition-opacity duration-500 group-hover:opacity-100">
