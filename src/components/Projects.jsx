...
const Projects = () => {
  return (
    <section
      ...
      id="projects"
    >
      <h2 className="mb-8 text-center text-4xl lg:text-4xl bg-gradient-to-r from-pink-300 via-slate-300 to-purple-500 bg-clip-text tracking-tight text-transparent">
        Projects
      </h2>
